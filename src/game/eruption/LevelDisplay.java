		...
		if(game.gameState == game.STATE.LEVEL1 && HUD.LEVEL1BOSSHEALTH<=0)
		{
			...
			else
			{
				...
				if(game.upgrades.isScoreBoost)
				{
					...
					{
						g.drawString("+2000",(int)Level1Boss.x-50,Game.HEIGHT/2+20);
					}
					else				
						g.drawString("+2000",(int)Level1Boss.x+40,(int)Level1Boss.y+200);
					scoreTime--;
				}
				else
				{
					if((int)Level1Boss.x+80+200>=Game.WIDTH)
					{
						g.drawString("+1000",(int)Level1Boss.x-50,Game.HEIGHT/2+20);
					}
					else				
						g.drawString("+1000",(int)Level1Boss.x+40,(int)Level1Boss.y+200);
					scoreTime--;
				}
			}
		}
		...
		if(game.gameState == game.STATE.LEVEL2 && HUD.LEVEL2BOSSHEALTH<=0)
		{
			...
			else
			{
				...
				if(game.upgrades.isScoreBoost)
				{
					...
					{
						g.drawString("+2000",(int)Level2Boss.x-50,Game.HEIGHT/2+20);
					}
					else				
						g.drawString("+2000",(int)Level2Boss.x+40,(int)Level2Boss.y+200);
					scoreTime2--;
				}
				else
				{
					if((int)Level2Boss.x+80+200>=Game.WIDTH)
					{
						g.drawString("+1000",(int)Level2Boss.x-50,Game.HEIGHT/2+20);
					}
					else				
						g.drawString("+1000",(int)Level2Boss.x+40,(int)Level2Boss.y+200);
					scoreTime2--;
				}
			}
		}
		...
		if(game.gameState == game.STATE.LEVEL3 && HUD.LEVEL3BOSSHEALTH<=0 )
		{
			...
			else
			{
				...
				if(game.upgrades.isScoreBoost)
				{
					...
					{
						g.drawString("+2000",(int)Level3Boss.x-50,Game.HEIGHT/2+20);
					}
					else				
						g.drawString("+2000",(int)Level3Boss.x+40,(int)Level3Boss.y+200);
					scoreTime3--;
				}
				else
				{
					if((int)Level3Boss.x+80+200>=Game.WIDTH)
					{
						g.drawString("+1000",(int)Level3Boss.x-50,Game.HEIGHT/2+20);
					}
					else				
						g.drawString("+1000",(int)Level3Boss.x+40,(int)Level3Boss.y+200);
					scoreTime3--;
				}
			}
		}
		...
		if(game.gameState == game.STATE.LEVEL4 && HUD.LEVEL4BOSSHEALTH<=0)
		{
			...
			else
			{
				...
				if(game.upgrades.isScoreBoost)
				{
					if((int)Level3Boss.x+80+200>=Game.WIDTH)
					{
						g.drawString("+6000",(int)Level4Boss.x-50,Game.HEIGHT/2+20);
					}
					else				
						g.drawString("+6000",(int)Level4Boss.x+40,(int)Level4Boss.y+200);
					scoreTime4--;
				}
				else
				{
					if((int)Level3Boss.x+80+200>=Game.WIDTH)
					{
						g.drawString("+3000",(int)Level4Boss.x-50,Game.HEIGHT/2+20);
					}
					else				
						g.drawString("+3000",(int)Level4Boss.x+40,(int)Level4Boss.y+200);
					scoreTime4--;
				}
			}
		}
