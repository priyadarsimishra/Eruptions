...
//		}
	...
	public void render(Graphics g)
	{
		...
		if(Game.gameState == game.STATE.LEVEL2 && game.level2pause>=500 && game.isBossFight2)
		{
			...
			{
				if(LEVEL2BOSSHEALTH == 200)
				{
		   			g.drawString(LEVEL2BOSSHEALTH+"",716,43);
				}
				else
				{
		   			g.drawString(LEVEL2BOSSHEALTH+"",730,43);
				}
			}
		}
		...
		if(game.gameState == game.STATE.LEVEL3 && game.level3pause>=500 && game.isBossFight3)
		{
			...
			{
				if(LEVEL3BOSSHEALTH == 200)
				{
		   			g.drawString(LEVEL3BOSSHEALTH+"",716,43);
				}
				else
				{
		   			g.drawString(LEVEL3BOSSHEALTH+"",735,43);
				}
			}
		...
		if(game.gameState == game.STATE.LEVEL4 && game.level4pause>=500 && game.isBossFight4)
		{
			...
			{
				if(LEVEL4BOSSHEALTH == 200) g.drawString(LEVEL4BOSSHEALTH+"",716,43);
				else g.drawString(LEVEL4BOSSHEALTH+"",735,43);
			}
		...
		g.drawImage(texture.shiftKey,1,95,62,60,null);
		g.drawString(" for Upgrades", 60, 135);
		g.setColor(Color.GRAY);
		...
		{
			g.setColor(Color.WHITE);
			g.drawRect(145,66,65+sector,21);
			g.setColor(Color.GRAY);
			g.fillRect(145,66,64+sector,20);
			g.setColor(aqua);
			g.fillRect(145,66,SHIELDHEALTH*8,20);
		}
