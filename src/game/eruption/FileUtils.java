...
//		fileUtils.store(new PlayerInfo("mama",25000,100,4));		
		...
		System.out.println(fileUtils.getHighestScore("bisu",1));
		System.out.println(fileUtils.getHighestScore("bisu",2));
		System.out.println(fileUtils.getHighestScore("bisu",3));
		System.out.println(fileUtils.getHighestScore("bisu",4));
		
		System.out.println(fileUtils.getThePlayerLevel("bisu"));
