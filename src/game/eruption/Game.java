...
public class Game extends Canvas implements Runnable
{
	...
	private ImageIcon selectLevelIcon;
	private ImageIcon customizeBackgroundIcon;
	private ImageIcon howtoPlayBackgroundIcon;
	private ImageIcon helpBackgroundIcon;
...
//		SoundPlayer.load();
	...
	public void runImage()
	{
		...
		howtoPlayBackgroundIcon = new ImageIcon(this.getClass().getResource("/HowToPlayScreen.jpg"));
		helpBackgroundIcon = new ImageIcon(this.getClass().getResource("/HelpBackground.gif"));
		selectLevelIcon = new ImageIcon(this.getClass().getResource("/SelectLevel.jpg"));
		selectLevel = selectLevelIcon.getImage();
		helpBackground = helpBackgroundIcon.getImage();
		howtoPlayImage = howtoPlayBackgroundIcon.getImage();
	...
	public void update()
	{
		if(gameState == STATE.MENU)
		{
			...
			menu.gameCompleteStoreStop = false;
			hud.stopScore = false;
	...
	private void render()
	{
		...
		{
			g.drawImage(selectLevel,0,0,WIDTH,HEIGHT,null);
			menu.render(g);
		}
		...
		{
			g.drawImage(helpBackground,0,0,WIDTH,HEIGHT,null);
			menu.render(g);
		}
		...
		{
			g.drawImage(howtoPlayImage,0,0,WIDTH,HEIGHT,null);
			menu.render(g);
		}  
		else if(gameState == STATE.LEVEL1)
		{
	...
	public void keyPressed(KeyEvent e)
	{
		...
		{
			SoundPlayer.getSound("water_bucket").play();
		...
		if(key == KeyEvent.VK_SPACE && !isShooting && gameState == STATE.LEVEL2 && !isBossFight2 && check)
		{
			...
			{
				SoundPlayer.getSound("pistol_shoot").play();
			...
			{
				SoundPlayer.getSound("sniper_shoot").play();
